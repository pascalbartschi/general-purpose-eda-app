...
Upload your data and get started exploring

Built with ❤️ by [pascalbartschi](https://github.com/pascalbartschi)
...
git clone git@github.com:pascalbartschi/general_purpose_eda_app.git
